      ...
      <div className="grid gap-6 xl:grid-cols-[360px_1fr]">
        <section className="rounded-[28px] border border-white/70 bg-white/95 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.07)] backdrop-blur">
          ...
          <p className="mt-2 text-sm text-slate-600">
            Start a structured conversation without turning it into live chat.
          </p>
                    ...
                    <button
                      ...
                      className={[
                        ...
                        selectedThreadId === thread.id
                          ...
                          : "border-slate-100 bg-gradient-to-br from-slate-50 to-white hover:border-slate-200 hover:bg-white",
                      ].join(" ")}
                    >
                ...
                <div className="space-y-5">
                  <div className="flex flex-col gap-4 border-b border-slate-100 pb-5">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-sm text-slate-600">
                        Client: {selectedThread.clientName || "Unknown"} · Last activity:{" "}
                        {formatThreadTimestamp(
