    ...
    <>
      <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(46,160,255,0.16),_transparent_34%),linear-gradient(to_bottom_right,_#f8fbff,_#eef5ff)] px-6 py-8 md:px-10 md:py-10">
        <div className="mx-auto max-w-6xl space-y-8">
            ...
            <div className="p-6 md:p-8">
              <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
                <div className="max-w-2xl">
                  ...
                  <p className="mt-3 text-sm text-slate-600 md:text-base">
                    Manage your application, complete your profile, and follow
                    your personalized bootcamp journey in one place.
                  </p>
              ...
              {applicationStatus === "approved" &&
                ...
                onboardingStatus === "incomplete" && (
                  <div className="mt-8 rounded-[24px] border border-amber-200 bg-gradient-to-br from-amber-50 to-white p-5 shadow-sm">
                    ...
                    <div className="mt-4">
                      <a
                        ...
                        className="inline-flex rounded-2xl bg-gradient-to-r from-[#2EA0FF] to-[#1B6EDC] px-4 py-2.5 text-sm font-medium text-white shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:shadow-md"
                      >
                        Complete Profile
                      </a>
                    </div>
          ...
          {showPendingPayment && (
            <section className="rounded-[28px] border border-amber-200 bg-gradient-to-br from-amber-50 to-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.07)]">
              <h2 className="text-xl font-semibold text-slate-950">
                Payment pending
              </h2>
              <p className="mt-2 text-slate-600">
          ...
          {showCashMessage && (
            <section className="rounded-[28px] border border-emerald-200 bg-gradient-to-br from-emerald-50 to-white p-6 shadow-[0_18px_50px_rgba(15,23,42,0.07)]">
              <h2 className="text-xl font-semibold text-slate-950">
                Payment arranged
              </h2>
              <p className="mt-2 text-slate-600">
            ...
            <section className="space-y-5">
              <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                ...
                {canSeeProgress && (
                  <a
                    href="/dashboard/progress"
                    className="inline-flex rounded-2xl border border-[#bfdbfe] bg-white px-4 py-2.5 text-sm font-medium text-[#1d4ed8] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-[#93c5fd] hover:bg-[#f8fbff] hover:shadow-md"
                  >
